...
public class AIAnalysisService {
    ...
    public AIAnalysisService(String primaryApiKey, String primaryModelName,
            String secondaryApiKey, String secondaryModelName) {
    ...
    public String analyze(String content, String pluginName) throws AIAnalysisException {
        ...
        if (secondaryApiKey != null && !secondaryApiKey.isEmpty() && !secondaryApiKey.startsWith("YOUR_")) {
            for (int i = 1; i <= 2; i++) {
                logger.info(
                        "[Attempt " + i + "/2] Trying SECONDARY model: " + secondaryModelName + " for " + pluginName);
